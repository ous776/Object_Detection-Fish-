...
namespace GamRent
{
    ...
    {
        private MySqlConnection con = new MySqlConnection("server=localhost; database=gamrent; user=root; password=; Persist Security Info=False; Connect Timeout=300;sslMode=none");
        private MySqlCommand cmd;
        private MySqlDataAdapter da;
        public DataTable dt;
        int result;
        //connection = ConfigurationManager.ConnectionStrings["MyContext"].ConnectionString;
