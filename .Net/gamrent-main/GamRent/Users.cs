...
namespace GamRent
{
    public partial class Users : Form
    {
        ...
        private void btn_New_Click(object sender, EventArgs e)
        {
            ...
            config.Load_DTG("Select Id as 'ID' ,name as 'Name',username as 'Username',Phone as 'Phone' From user", dtg_listUser);
        ...
        private void btn_saveuser_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "insert into user (name,username,pass,phone) "
        ...
        {
            sql = "delete from user where id = '" + lbl_id.Text + "'";
